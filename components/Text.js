...
var Text = function (_Component) {
    ...
    _createClass(Text, [{
        ...
        value: function getClassName(props) {
            ...
            return newProps + _get(Text.prototype.__proto__ || Object.getPrototypeOf(Text.prototype), 'getClassName', this).call(this, props);
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'span',
                { className: "uk-text " + this.getClassName(this.props) },
                this.props.children
            );
        }
    }]);
